...
function Toolbar() {
    ...
    const handleSelectionToolClick = () => {
        const newState = !isSelectionToolActive;
        setIsSelectionToolActive(newState);
        if (!newState) {
            setSelection(null);
        }
    };
    ...
    return (
        <div className="toolbar">
            ...
            <button 
                onClick={handleSelectionToolClick}
                className={`toolbar-button ${isSelectionToolActive ? 'active' : ''}`}
