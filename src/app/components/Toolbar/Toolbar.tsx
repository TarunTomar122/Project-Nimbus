...
function Toolbar() {
    ...
    return (
        <div className="toolbar">
            <button onClick={() => setNodes([...nodes, { id: generateId(), type: 'card', position: { x: 0, y: 0 }, data: { attributes: [{ label: 'Attribute 1', id: generateId() }], actions: [{ label: 'Action 1', id: generateId() } ] } }])}>
